...
const odosRouter = '0xCf5540fFFCdC3d510B18bFcA6d2b9987b0772559'
...
const leaves = [
    ...
    ...tokenMintSyrupUSDC.map(token => {
        return routers.map(extRouter => {
